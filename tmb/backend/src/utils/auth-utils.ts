...
import { COOKIE_NAMES, setSessionCookie, fetchUserSession, sessionCache } from './session';
...
/** Factory to create auth middleware ('secure') to secure local API & auth API endpoints
